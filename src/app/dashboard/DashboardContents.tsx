...
export const DashboardContents = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] px-4 py-8 md:py-16">
      {showLevelUp && (
        <LevelUpModal level={character.current_level} onClose={() => setShowLevelUp(false)} />
      )}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <section className="space-y-6">
            ...
            <div className="bg-indigo-600 text-white rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group border border-indigo-400/50">
              ...
              <p className="text-indigo-50 font-bold text-lg leading-relaxed">"{quote}"</p>
            </div>
